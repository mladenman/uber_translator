...
class Translator(object):
    def __init__(self, xseq_len, yseq_len,
                 ...
                 emb_dim, num_layers, ckpt_path, layer_size=3,
                 lr=0.0001,
                 epochs=100000, model_name='translator_model'):
        ...
        def __graph__():
            ...
            basic_cell = tf.contrib.rnn.core_rnn_cell.DropoutWrapper(
                tf.contrib.rnn.core_rnn_cell.BasicLSTMCell(layer_size, state_is_tuple=True),
            ...
            with tf.variable_scope('decoder') as scope:
                ...
                self.decode_outputs, self.decode_states = tf.contrib.legacy_seq2seq.embedding_rnn_seq2seq(self.enc_ip, self.dec_ip,
                                                                                              stacked_lstm,
                                                                                              xvocab_size, yvocab_size,
                                                                                              emb_dim)
                # share parameters
